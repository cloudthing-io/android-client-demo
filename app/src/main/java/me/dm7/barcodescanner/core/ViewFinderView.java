...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = 0;
    private final int mDefaultMaskColor = 0;
    private final int mDefaultBorderColor = 0;
    private final int mDefaultBorderStrokeWidth = 10;
    private final int mDefaultBorderLineLength = 10;
